...
/**
 * Implements the New Relic command line option to list plugins.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ListPlugins extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ListPlugins.class.getName());
