...
public class CreateInfraProcessRunningAlertCondition extends BaseCommand
{
    ...
    protected void options()
    {
        ...
        options.addOption("pwc", "process_where_clause", true, "The process_where_clause of the condition, optional");
    ...
    protected void parse(CommandLine cli)
    {
        ...
        if(cli.hasOption("th"))
        {
            threshold = Integer.parseInt(cli.getOptionValue("th"));
        ...
        if(cli.hasOption("pwc"))
        {
            processWhereClause = cli.getOptionValue("pwc");
            logOptionValue("process_where_clause", processWhereClause);
        }
