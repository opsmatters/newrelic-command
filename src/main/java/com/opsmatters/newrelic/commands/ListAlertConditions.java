...
/**
 * Implements the New Relic command line option to list alert conditions.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ListAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ListAlertConditions.class.getName());
    private static final String NAME = "list_alert_conditions";
    ...
    protected void operation()
    {
        ...
        Collection<AlertCondition> conditions = api.alertConditions().list(p.getId());
        if(verbose)
