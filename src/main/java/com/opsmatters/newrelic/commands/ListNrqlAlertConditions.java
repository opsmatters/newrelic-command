...
/**
 * Implements the New Relic command line option to list NRQL alert conditions.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ListNrqlAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ListNrqlAlertConditions.class.getName());
    private static final String NAME = "list_nrql_alert_conditions";
     ...
     * Default constructor.
     */
    public ListNrqlAlertConditions()
    {
        options();
    }
    ...
    protected void execute()
    {
        ...
        Collection<NrqlAlertCondition> conditions = api.nrqlAlertConditions().list(p.getId());
        if(verbose())
            logger.info("Found "+conditions.size()+" NRQL alert conditions");
