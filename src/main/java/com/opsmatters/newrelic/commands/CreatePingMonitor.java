...
/**
 * Implements the New Relic command line option to create a Synthetics ping monitor.  
 * 
...
public class CreatePingMonitor extends BaseCommand
{
    ...
    protected void execute()
    {
        ...
        Monitor sm = SimpleMonitor.builder()
            ...
            .bypassHeadRequestOption(bypassHeadRequest)
            .treatRedirectAsFailureOption(treatRedirectAsFailure)
