...
/**
 * Implements the New Relic command line option to import a set of email alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportEmailChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportEmailChannels.class.getName());
    private static final String NAME = "import_email_channels";
    ...
    /**
     * Import the email alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readEmailChannels(filename, worksheet, 
