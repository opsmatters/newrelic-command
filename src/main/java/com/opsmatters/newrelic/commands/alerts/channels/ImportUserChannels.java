...
/**
 * Implements the New Relic command line option to import a set of User alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportUserChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportUserChannels.class.getName());
    private static final String NAME = "import_user_channels";
    ...
    /**
     * Import the User alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readUserChannels(filename, worksheet, 
