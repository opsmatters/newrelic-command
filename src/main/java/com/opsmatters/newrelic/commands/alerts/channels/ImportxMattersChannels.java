...
/**
 * Implements the New Relic command line option to import a set of xMatters alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportxMattersChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportxMattersChannels.class.getName());
    private static final String NAME = "import_xmatters_channels";
    ...
    /**
     * Import the xMatters alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readxMattersChannels(filename, worksheet, 
