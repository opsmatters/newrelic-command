...
/**
 * Implements the New Relic command line option to export a set of external service alert conditions.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportExternalServiceAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportExternalServiceAlertConditions.class.getName());
    private static final String NAME = "export_external_service_alert_conditions";
     ...
     * Default constructor.
     */
    public ExportExternalServiceAlertConditions()
    {
        options();
    }
    ...
    /**
     * Export the external service alert conditions.
     */
    protected void execute()
    {
        ...
        List<ExternalServiceAlertCondition> conditions = manager.getExternalServiceAlertConditions(policyList.list(policy));
        ...
        try
        {
            ...
            manager.writeExternalServiceAlertConditions(policies, entities, conditions, filename, worksheet, 
