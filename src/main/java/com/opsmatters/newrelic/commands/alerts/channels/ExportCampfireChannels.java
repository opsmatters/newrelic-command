...
/**
 * Implements the New Relic command line option to export a set of Campfire alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportCampfireChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportCampfireChannels.class.getName());
    private static final String NAME = "export_campfire_channels";
    ...
    /**
     * Export the Campfire alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writeCampfireChannels(channels, filename, worksheet, 
