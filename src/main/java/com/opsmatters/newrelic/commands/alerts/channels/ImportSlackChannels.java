...
/**
 * Implements the New Relic command line option to import a set of Slack alert channels.
 * 
...
public class ImportSlackChannels extends BaseCommand
{
    ...
    /**
     * Import the Slack alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readSlackChannels(filename, worksheet, 
