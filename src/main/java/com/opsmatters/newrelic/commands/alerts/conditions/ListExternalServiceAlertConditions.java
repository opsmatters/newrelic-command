...
/**
 * Implements the New Relic command line option to list external service alert conditions.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ListExternalServiceAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ListExternalServiceAlertConditions.class.getName());
    private static final String NAME = "list_external_service_alert_conditions";
     ...
     * Default constructor.
     */
    public ListExternalServiceAlertConditions()
    {
        options();
    }
    ...
    protected void execute()
    {
        ...
        Collection<ExternalServiceAlertCondition> conditions = api.externalServiceAlertConditions().list(p.getId());
        if(verbose())
            logger.info("Found "+conditions.size()+" external service alert conditions");
