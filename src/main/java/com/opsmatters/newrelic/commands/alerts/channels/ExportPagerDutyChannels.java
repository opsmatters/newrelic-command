...
/**
 * Implements the New Relic command line option to export a set of PagerDuty alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportPagerDutyChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportPagerDutyChannels.class.getName());
    private static final String NAME = "export_pagerduty_channels";
     ...
     * Default constructor.
     */
    public ExportPagerDutyChannels()
    {
        options();
    }
    ...
    /**
     * Export the PagerDuty alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writePagerDutyChannels(channels, filename, worksheet, 
