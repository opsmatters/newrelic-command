...
/**
 * Implements the New Relic command line option to import a set of alert conditions.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportAlertConditions.class.getName());
    private static final String NAME = "import_alert_conditions";
    ...
    protected void execute()
    {
        ...
        try
        {
            ...
            config.setAlertConditions(manager.readAlertConditions(policies, entities, filename, worksheet, 
        ...
        if(delete)
            manager.deleteAlertConditions(config.getAlertConditions());

        // Create the new alert conditions
        manager.createAlertConditions(config.getAlertConditions());
    }
}