...
/**
 * Implements the New Relic command line option to delete Plugins alert conditions.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class DeletePluginsAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(DeletePluginsAlertConditions.class.getName());
    private static final String NAME = "delete_plugins_alert_conditions";
     ...
     * Default constructor.
     */
    public DeletePluginsAlertConditions()
    {
        options();
    }
    ...
    protected void execute()
    {
        ...
        {
            logger.severe("Unable to find Plugins alert conditions: "+name);
            return;
        }
        ...
        for(PluginsAlertCondition condition : conditions)
        {
            ...
            logger.info("Deleted Plugins alert condition: "+condition.getId()+" - "+condition.getName());
        }
    }
}