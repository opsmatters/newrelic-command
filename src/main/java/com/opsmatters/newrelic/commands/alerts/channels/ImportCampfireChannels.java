...
/**
 * Implements the New Relic command line option to import a set of Campfire alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportCampfireChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportCampfireChannels.class.getName());
    private static final String NAME = "import_campfire_channels";
    ...
    /**
     * Import the Campfire alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readCampfireChannels(filename, worksheet, 
