...
/**
 * Implements the New Relic command line option to import a set of HipChat alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportHipChatChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportHipChatChannels.class.getName());
    private static final String NAME = "import_hipchat_channels";
    ...
    /**
     * Import the HipChat alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readHipChatChannels(filename, worksheet, 
