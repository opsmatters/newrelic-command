...
/**
 * Implements the New Relic command line option to export a set of infrastructure metric alert conditions.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportInfraMetricAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportInfraMetricAlertConditions.class.getName());
    private static final String NAME = "export_infra_metric_conditions";
     ...
     * Default constructor.
     */
    public ExportInfraMetricAlertConditions()
    {
        options();
    }
    ...
    /**
     * Export the infrastructure metric alert conditions.
     */
    protected void execute()
    {
        ...
        List<InfraMetricAlertCondition> conditions = manager.getInfraMetricAlertConditions(policyList.list(policy));
        ...
        try
        {
            ...
            manager.writeInfraMetricAlertConditions(policies, conditions, filename, worksheet, 
