...
/**
 * Implements the New Relic command line option to export a set of Slack alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportSlackChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportSlackChannels.class.getName());
    private static final String NAME = "export_slack_channels";
    ...
    /**
     * Export the Slack alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writeSlackChannels(channels, filename, worksheet, 
