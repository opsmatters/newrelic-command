...
/**
 * Implements the New Relic command line option to export a set of email alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportEmailChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportEmailChannels.class.getName());
    private static final String NAME = "export_email_channels";
    ...
    /**
     * Export the email alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writeEmailChannels(channels, filename, worksheet, 
