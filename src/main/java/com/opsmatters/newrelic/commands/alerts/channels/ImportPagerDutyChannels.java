...
/**
 * Implements the New Relic command line option to import a set of PagerDuty alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportPagerDutyChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportPagerDutyChannels.class.getName());
    private static final String NAME = "import_pagerduty_channels";
     ...
     * Default constructor.
     */
    public ImportPagerDutyChannels()
    {
        options();
    }
    ...
    /**
     * Import the PagerDuty alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readPagerDutyChannels(filename, worksheet, 
