...
/**
 * Implements the New Relic command line option to export a set of NRQL alert conditions.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportNrqlAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportNrqlAlertConditions.class.getName());
    private static final String NAME = "export_nrql_alert_conditions";
     ...
     * Default constructor.
     */
    public ExportNrqlAlertConditions()
    {
        options();
    }
    ...
    /**
     * Export the NRQL alert conditions.
     */
    protected void execute()
    {
        ...
        List<NrqlAlertCondition> conditions = manager.getNrqlAlertConditions(policyList.list(policy));
        ...
        try
        {
            ...
            manager.writeNrqlAlertConditions(policies, conditions, filename, worksheet, 
