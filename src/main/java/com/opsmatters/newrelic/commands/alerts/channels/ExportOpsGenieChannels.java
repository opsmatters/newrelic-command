...
/**
 * Implements the New Relic command line option to export a set of OpsGenie alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportOpsGenieChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportOpsGenieChannels.class.getName());
    private static final String NAME = "export_opsgenie_channels";
    ...
    /**
     * Export the OpsGenie alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writeOpsGenieChannels(channels, filename, worksheet, 
