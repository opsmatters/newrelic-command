...
/**
 * Implements the New Relic command line option to list Infrastructure alert conditions.  
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ListInfraAlertConditions extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ListInfraAlertConditions.class.getName());
    private static final String NAME = "list_infra_alert_conditions";
     ...
     * Default constructor.
     */
    public ListInfraAlertConditions()
    {
        options();
    }
    ...
    protected void execute()
    {
        ...
        Collection<InfraAlertCondition> conditions = infraApi.infraAlertConditions().list(p.getId());
        if(verbose())
            logger.info("Found "+conditions.size()+" infra alert conditions");
