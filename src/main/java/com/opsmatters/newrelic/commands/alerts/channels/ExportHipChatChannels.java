...
/**
 * Implements the New Relic command line option to export a set of HipChat alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportHipChatChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportHipChatChannels.class.getName());
    private static final String NAME = "export_hipchat_channels";
    ...
    /**
     * Export the HipChat alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writeHipChatChannels(channels, filename, worksheet, 
