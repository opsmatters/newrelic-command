...
/**
 * Implements the New Relic command line option to import a set of VictorOps alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ImportVictorOpsChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ImportVictorOpsChannels.class.getName());
    private static final String NAME = "import_victorops_channels";
     ...
     * Default constructor.
     */
    public ImportVictorOpsChannels()
    {
        options();
    }
    ...
    /**
     * Import the VictorOps alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            config.addAlertChannels(manager.readVictorOpsChannels(filename, worksheet, 
