...
/**
 * Implements the New Relic command line option to export a set of User alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportUserChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportUserChannels.class.getName());
    private static final String NAME = "export_user_channels";
    ...
    /**
     * Export the User alert channels.
     */
    protected void execute()
    {
        ...
        List<UserChannel> channels = config.getUserChannels();
        ...
        try
        {
            ...
            manager.writeUserChannels(channels, filename, worksheet, 
