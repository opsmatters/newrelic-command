...
/**
 * Implements the New Relic command line option to export a set of xMatters alert channels.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class ExportxMattersChannels extends BaseCommand
{
    private static final Logger logger = Logger.getLogger(ExportxMattersChannels.class.getName());
    private static final String NAME = "export_xmatters_channels";
    ...
    /**
     * Export the xMatters alert channels.
     */
    protected void execute()
    {
        ...
        try
        {
            ...
            manager.writexMattersChannels(channels, filename, worksheet, 
